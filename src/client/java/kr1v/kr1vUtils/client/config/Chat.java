...
public class Chat {
	...
	public static final ConfigBooleanHotkeyed REDIRECT_TO_SUBTITLES = new ConfigBooleanPlus("Redirect matched messages to the subtitle hud element", true, "", "");
	public static final ConfigBooleanHotkeyed ALLOW_DUPLICATE_SUBTITLES = new ConfigBooleanPlus("Duplicate subtitles", false, "", "Allow having multiple of the same message after each other in the subtitles");
	public static final ConfigBooleanHotkeyed CHAT_SELECTING = new ConfigBooleanPlus("Chat selecting", true, "LEFT_CONTROL,C", KeybindSettings.GUI, "Be able to select and copy the chat", "", "");
	...
	public static final ConfigBooleanHotkeyed ADD_HOVER_TIMESTAMP = new ConfigBooleanPlus("Add hover timestamp", true);
